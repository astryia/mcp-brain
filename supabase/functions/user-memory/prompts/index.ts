...
const ENRICHMENT_GUIDANCE = [
  `**Enrich before storing.** Raw input is usually terse and will be unreadable in 6 months without the surrounding chat. Before calling \`add_memory\`:`,
  ``,
  `1. Rewrite the content as a **self-contained sentence**:`,
  ...
  `2. If you don't have enough context to enrich confidently, first call \`search_memories\` (scoped by likely \`type\` and \`category_path\`) to pull related memories.`,
  `3. If still ambiguous, ask the user **one** clarifying question instead of guessing.`,
  ``,
